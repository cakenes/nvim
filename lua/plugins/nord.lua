return {
    ...
    config = function()
        ...
        -- Nord0 is the darkest background, Nord3 is a brighter gray/Polar Night
        vim.api.nvim_set_hl(0, "NotifyBackground", { bg = colors.nord0 })

        -- Diagnostics (Using Nord3/Nord4 for subtle hints)
